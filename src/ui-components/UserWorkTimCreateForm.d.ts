...
export declare type UserWorkTimCreateFormInputValues = {
    Monday_start?: string;
    Monday_end?: string;
...
export declare type UserWorkTimCreateFormValidationValues = {
...
export declare type UserWorkTimCreateFormOverridesProps = {
    UserWorkTimCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type UserWorkTimCreateFormProps = React.PropsWithChildren<{
    overrides?: UserWorkTimCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: UserWorkTimCreateFormInputValues) => UserWorkTimCreateFormInputValues;
    onSuccess?: (fields: UserWorkTimCreateFormInputValues) => void;
    onError?: (fields: UserWorkTimCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: UserWorkTimCreateFormInputValues) => UserWorkTimCreateFormInputValues;
    onValidate?: UserWorkTimCreateFormValidationValues;
} & React.CSSProperties>;
export default function UserWorkTimCreateForm(props: UserWorkTimCreateFormProps): React.ReactElement;
