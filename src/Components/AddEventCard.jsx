...
const AddEventCard = ({ event, Close, onConfirm }) => {
    console.log('in add event card:', onConfirm);
        ...
        <div>
            {<div className="event-details-card bg-gray-800 text-white rounded-lg shadow-lg p-6">
                ...
                <div className="options mt-4">
                    <button className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 mr-2 rounded" onClick={onConfirm(true)}>Accept</button>
                    <button className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded" onClick={onConfirm(false)}>Delete</button>
                </div>
            </div>}
