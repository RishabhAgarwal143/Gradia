...
function Navbar({ toggleComponent, handleSignOut, showBasicCalendar, handleUserTimes }) {
  return (
      ...
      <div className="container mx-auto flex justify-center items-center">
        <div>
          <button className="text-white mr-4" onClick={toggleComponent}>
            <span className="text-white px-5">{showBasicCalendar ? "Show GradeView" : "Show BasicCalendar"}</span>
          </button>
        </div>
