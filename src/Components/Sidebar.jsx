...
const Sidebar = () => {
    ...
    return (
        <div className=" text-white p-4 overflow-y-auto rounded-lg" style={{ maxHeight: 'calc(100vh - 100px)' }}>
                ...
                <ul className="grid gap-4">
                    {schedules.map((schedule) => (
                        <li key={schedule.id} className="bg-gray-800 p-4 rounded-lg">
                            ...
                            <div className="text-sm text-gray-400">{new Date(schedule.DUE).toLocaleDateString()}</div>
